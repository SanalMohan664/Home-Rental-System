		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "TechNest",
									"targetURL": "#comapplexustechnest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comapplexustechnest-display": {
								"semanticObject": "comapplexustechnest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.applexus.technest",
									"url": sap.ui.require.toUrl("com/applexus/technest")
								}
							}
						}
					}
